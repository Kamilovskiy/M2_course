...
namespace M2Catalogue\ScandiwebTest\Setup\Patch\Data;
...
class CreateSimpleProduct implements DataPatchInterface
{
    ...
    public function execute(): void
    {
        ...
        if ($product->getIdBySku('god_awful_pants')) {
            return;
        }
        ...
        $product->setTypeId(Type::TYPE_SIMPLE)
            ...
            ->setName('God Awful Pants')
            ->setUrlKey('godawfulpants')
            ->setSku('god-awful-pants')
            ->setPrice(10)
